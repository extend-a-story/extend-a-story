...
# This creates a database for version 2.1.x of Extend-A-Story to test the upgrade process.
...
insert into User values( 1, 4, "admin", "please-change-me", "Administrator" );
