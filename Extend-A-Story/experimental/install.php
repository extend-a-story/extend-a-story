...
*/
  ...
  $host     = "localhost";
  $user     = "jjweston";
  $password = "thequestthatneverends";
  $database = "<database>";

  $queries = array(

// ********** Start SQL Creation Section **********
...
"insert into Scheme values( 1, 'Black Text on White Background',
                            '#FFFFFF', '#000000', '#0000FF', '#FF0000', '#00FF00', '',
                            'images/red.gif', 'images/green.gif', 'images/blue.gif' )",

"insert into Scheme values( 2, 'White Text on Black Background', 
                            '#000000', '#FFFFFF', '#00FF00', '#FF0000', '#0000FF', '',
                            'images/red.gif', 'images/green.gif', 'images/blue.gif' )"

// ********** End SQL Creation Section **********
...
Installtion of your Extend-A-Story database is complete. You should now
